"""LSTM binary classifier with participant-level static covariate fusion."""
...
class MaskedLSTMCovariateClassifier(MaskedRecurrentCovariateClassifier):
    """LSTM encoder with a static-covariate branch and binary fusion head."""
